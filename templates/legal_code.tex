...
%%% With options for special document styles (notes, exam, grading) 
...
\usepackage{fontspec}
\setmainfont{Sabon LT}[Mapping={tex-text}]
\setsansfont{Lato}[Mapping=tex-text,Scale=0.9]
\setmonofont{Cousine}[Mapping=tex-text,Scale=0.8]
\newfontface\titlefont{Sabon LT}[Colour=mydarkred]
...
% \setlist[enumerate]{wide,itemsep=.5em,topsep=0em,partopsep=0em,parsep=0em,}
\setlist[enumerate]{topsep=0.5em,itemsep=0.5em,partopsep=0em,parsep=0em,align=left}
% \setlist[enumerate]{leftmargin=*,itemindent=*,topsep=0.5em,itemsep=0.5em,partopsep=0em,parsep=0em,align=left}
% \setlist[1]{itemindent=1em} % Only the level 1
...
\AtBeginEnvironment{quote}{\footnotesize\sffamily} 

\renewenvironment{quote}{%
   \list{}{%
     \leftmargin0em   % this is the adjusting screw
